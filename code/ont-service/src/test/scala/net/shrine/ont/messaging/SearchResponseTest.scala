...
final class SearchResponseTest extends FromJsonTest(SearchResponse) {
  ...
  val concept1 = Concept(Concept.shrinePrefix + """category1\concept1Key""", None)
  val concept2 = Concept(Concept.shrinePrefix + """category1\concept2Key""", None)
  val concept3 = Concept(Concept.shrinePrefix + """category1\concept3Key""", None)

  val searchResponse = new SearchResponse("test", Seq(concept1, concept2, concept3))

 ...
 */
final class DefaultShrineProxyTest extends TestCase with ShouldMatchers with AssertionsForJUnit {
  ...
  def testRedirect {
    ...
    shouldWork.foreach { url =>
      ...
      proxy.redirect(inputXml) should equal("OK")
...
object DefaultShrineProxyTest {
  final class MockUrlPoster extends ShrineProxy.UrlPoster {
    var url: String = _
    var input: String = _

    override def post(url: String, input: String): String = {
      this.url = url
      this.input = input
  ...
  def getQuery(url: String): NodeSeq = {
    XmlUtil.stripWhitespace(<ns6:request xmlns:ns4="http://www.i2b2.org/xsd/cell/crc/psm/1.1/" xmlns:ns7="http://www.i2b2.org/xsd/cell/ont/1.1/" xmlns:ns3="http://www.i2b2.org/xsd/cell/crc/pdo/1.1/" xmlns:ns5="http://www.i2b2.org/xsd/hive/plugin/" xmlns:ns2="http://www.i2b2.org/xsd/hive/pdo/1.1/" xmlns:ns6="http://www.i2b2.org/xsd/hive/msg/1.1/" xmlns:ns8="http://www.i2b2.org/xsd/cell/crc/psm/querydefinition/1.1/">
                              <message_header>

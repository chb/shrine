...
public abstract class AbstractRequestResponseDataTest extends AbstractTransactionalDataSourceSpringContextTests
{
    ...
    protected final MasterTuple master1 = new MasterTuple(IDPair.of(masterID1, localMasterID1),
            "<ns2:query_definition xmlns:ns2=\"http://www.i2b2.org/xsd/cell/crc/psm/querydefinition/1.1/\">\n" +
                    "<query_name>" + masterName1 + "</query_name></ns2:query_definition>");
    protected final MasterTuple master2 = new MasterTuple(IDPair.of(masterID2, localMasterID2),
            "<ns2:query_definition xmlns:ns2=\"http://www.i2b2.org/xsd/cell/crc/psm/querydefinition/1.1/\">\n" +
                    "<query_name>master2</query_name></ns2:query_definition>");
    protected final MasterTuple master3 = new MasterTuple(IDPair.of(masterID3, localMasterID2),
            "<ns2:query_definition xmlns:ns2=\"http://www.i2b2.org/xsd/cell/crc/psm/querydefinition/1.1/\">\n" +
                    "<query_name>master3</query_name></ns2:query_definition>");
    protected final MasterTuple master4 = new MasterTuple(IDPair.of(masterID4, localMasterID2),
            "<ns2:query_definition xmlns:ns2=\"http://www.i2b2.org/xsd/cell/crc/psm/querydefinition/1.1/\">\n" +
    ...
    protected void mapUsersToMasterIDs() throws DAOException
    {
        ...
        {
            mappings.add(new UserAndMaster(requestResponseData.getDomainName(),
                    requestResponseData.getUsername(),
                    requestResponseData.getBroadcastQueryMasterId(),
                    masterIDsToNames.get(requestResponseData.getBroadcastQueryMasterId()),
                    masterIDsToTimes.get(requestResponseData.getBroadcastQueryMasterId())));
        }

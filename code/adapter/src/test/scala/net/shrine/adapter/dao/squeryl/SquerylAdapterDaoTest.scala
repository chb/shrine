 ...
 * @date May 24, 2013
 */
final class SquerylAdapterDaoTest extends AbstractShrineJUnitSpringTest with AbstractSquerylAdapterTest with ShouldMatchersForJUnit with Loggable {
  ...
  private def now = Option(Util.now)

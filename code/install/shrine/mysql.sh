...
wget ${SHRINE_SVN_URL_BASE}/code/adapter/src/main/resources/request-response-data-create.sql

mysql -u $SHRINE_MYSQL_USER -p$SHRINE_MYSQL_PASSWORD -D shrine_query_history < request-response-data-create.sql

wget ${SHRINE_SVN_URL_BASE}/code/broadcaster-aggregator/src/main/resources/create_broadcaster_audit_table.sql

...
sqlplus ${I2B2_ORACLE_HIVE_USER}/${I2B2_ORACLE_HIVE_PASSWORD}@${I2B2_ORACLE_SID} < clean_hive.sql
...
sqlplus ${I2B2_ORACLE_PM_USER}/${I2B2_ORACLE_PM_PASSWORD}@${I2B2_ORACLE_SID} < clean_pm.sql.interpolated

echo "[i2b2/clean.sh] ONT: Removing Ontology User and Data"

interpolate_file clean_ontology.sql "I2B2_ORACLE_SHRINE_ONT_USER" "${I2B2_ORACLE_SHRINE_ONT_USER}" > clean_ontology.sql.interpolated

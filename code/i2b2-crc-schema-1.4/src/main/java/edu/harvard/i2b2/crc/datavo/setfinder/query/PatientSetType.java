...
public class PatientSetType {
    ...
    protected List<CohortPatient> cohortPatient;
     ...
     * {@link edu.harvard.i2b2.crc.datavo.setfinder.query.PatientSetType.CohortPatient }
     * 
     * 
     */
    public List<CohortPatient> getCohortPatient() {
        if (cohortPatient == null) {
            cohortPatient = new ArrayList<CohortPatient>();
        }

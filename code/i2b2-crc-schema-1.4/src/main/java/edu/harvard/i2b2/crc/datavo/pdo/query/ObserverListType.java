...
public class ObserverListType {
    ...
    protected List<ObserverPath> observerPath;
     ...
     * {@link edu.harvard.i2b2.crc.datavo.pdo.query.ObserverListType.ObserverPath }
     * 
     * 
     */
    public List<ObserverPath> getObserverPath() {
        if (observerPath == null) {
            observerPath = new ArrayList<ObserverPath>();
        }

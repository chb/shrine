...
public class MasterResponseType extends ResponseType
{
     ...
     * <CODE>set</CODE> method for the queryMaster property.
     * <p/>
     * <p/>
    ...
    public int hashCode()
    {
        ...
        result = prime * result + ((queryMaster == null) ? 0 : queryMaster.hashCode());
        return result;
    }
    ...
    public boolean equals(final Object obj)
    {
        ...
        final MasterResponseType other = (MasterResponseType) obj;
        if(queryMaster == null)
        {
            if(other.queryMaster != null)
            {
                return false;
            }
        }
        else if(!queryMaster.equals(other.queryMaster))
        {
            return false;
        }
        return true;
    ...
    {
        return "MasterResponseType [queryMaster=" + queryMaster + "]";
    }
}

...
public class ItemType {
     ...
     * {@link edu.harvard.i2b2.crc.datavo.setfinder.query.ItemType.ConstrainByValue }
     * 
     * 
     */
    public List<ConstrainByValue> getConstrainByValue() {
        if (constrainByValue == null) {
            constrainByValue = new ArrayList<ConstrainByValue>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link edu.harvard.i2b2.crc.datavo.setfinder.query.ItemType.ConstrainByDate }
     * 
     * 
     */
    public List<ConstrainByDate> getConstrainByDate() {
        if (constrainByDate == null) {
            constrainByDate = new ArrayList<ConstrainByDate>();
        }
    ...
    public static class ConstrainByDate {
         ...
         * @return
         *     possible object is
         *     {@link edu.harvard.i2b2.crc.datavo.setfinder.query.ConstrainDateType }
         *     
         */
    ...
    public static class ConstrainByValue {
         ...
         * @return
         *     possible object is
         *     {@link edu.harvard.i2b2.crc.datavo.setfinder.query.ConstrainOperatorType }
         *     
         */
         ...
         * @return
         *     possible object is
         *     {@link edu.harvard.i2b2.crc.datavo.setfinder.query.ConstrainValueType }
         *     
         */

...
public class PasswordType {
    ...
    public boolean equals(Object o) {
        ...
        PasswordType that = (PasswordType) o;

        if (isToken != null ? !isToken.equals(that.isToken) : that.isToken != null) return false;
        if (tokenMsTimeout != null ? !tokenMsTimeout.equals(that.tokenMsTimeout) : that.tokenMsTimeout != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (tokenMsTimeout != null ? tokenMsTimeout.hashCode() : 0);
        return result;
    }
}

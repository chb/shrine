...
public final class QuerySummarizer {
    ...
    static String summarize(final ReadOnlyQueryGroup queryGroup, final String queryGroupCssClass) {
        ...
        if (expr instanceof Term) {
            ...
            // FIXME (Perhaps REVISITME): Allow multi-category expressions; will
            // make the summary less accurate,
            // but multi-category expressions are rare (says Andy), and will be
            // avoided at the
            // 8 May 2012 demo.

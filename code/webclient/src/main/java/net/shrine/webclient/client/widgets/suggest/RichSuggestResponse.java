 ...
 * @date Apr 5, 2012
 */
public class RichSuggestResponse<S extends IsSerializable> implements IsSerializable {
	...
	public static final <S extends IsSerializable> RichSuggestResponse<S> of(final Collection<S> suggestions) {
		return new RichSuggestResponse<S>(suggestions);
	}
	
	public static final <S extends IsSerializable> RichSuggestResponse<S> empty() {

...
final class ConceptTest extends FromJsonTest(Concept) {
  ...
  val concept1 = Concept(Concept.shrinePrefix + cat1 + """\concept1Key\""", Some("someSynonym"))
  val concept2 = Concept(Concept.shrinePrefix + cat1 + """\concept2Key""", None)
  val concept3 = Concept(Concept.shrinePrefix + cat2 + """\concept3Key""", Some("someSynonym"))

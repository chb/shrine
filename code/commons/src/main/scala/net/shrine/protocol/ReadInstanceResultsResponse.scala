...
import edu.harvard.i2b2.crc.datavo.setfinder.query.{QueryStatusTypeType, QueryResultTypeType, QueryResultInstanceType, QueryInstanceType}
...
object ReadInstanceResultsResponse extends I2b2Umarshaller[ReadInstanceResultsResponse] with XmlUnmarshaller[ReadInstanceResultsResponse] {

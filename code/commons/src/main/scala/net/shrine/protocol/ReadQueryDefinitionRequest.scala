...
import net.shrine.serializers.crc.CRCRequestType.GetRequestXml
...
object ReadQueryDefinitionRequest extends I2b2Umarshaller[ReadQueryDefinitionRequest] with ShrineRequestUnmarshaller[ReadQueryDefinitionRequest] {

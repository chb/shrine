...
import net.shrine.serializers.crc.CRCRequestType.MasterRequestType
...
object ReadQueryInstancesRequest extends I2b2Umarshaller[ReadQueryInstancesRequest] with ShrineRequestUnmarshaller[ReadQueryInstancesRequest] {

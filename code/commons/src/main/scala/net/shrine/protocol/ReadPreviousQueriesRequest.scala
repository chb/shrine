...
import net.shrine.serializers.crc.CRCRequestType.UserRequestType
...
object ReadPreviousQueriesRequest extends I2b2Umarshaller[ReadPreviousQueriesRequest] with ShrineRequestUnmarshaller[ReadPreviousQueriesRequest] {

...
import xml.{NodeSeq, XML, Utility}
...
object ReadQueryDefinitionResponse extends I2b2Umarshaller[ReadQueryDefinitionResponse] with XmlUnmarshaller[ReadQueryDefinitionResponse] {

...
import net.shrine.serializers.crc.CRCRequestType.MasterRenameRequestType
...
final case class RenameQueryRequest(
    ...
    val queryId: Long,
    val queryName: String) extends ShrineRequest(projectId, waitTimeMs, authn) with TranslatableRequest[RenameQueryRequest] {
...
object RenameQueryRequest extends I2b2Umarshaller[RenameQueryRequest] with ShrineRequestUnmarshaller[RenameQueryRequest] {

...
i2b2.PM.model.html.loginDialog = '<div id="i2b2_login_modal_dialog" style="display:block;">\n'+
	...
	'				<div class="label">'+i2b2.hive.cfg.username_label +
	//Username:+
	'</div>\n'+
	'				<div class="input"><input type="text" name="uname" id="loginusr" value="" size="20" maxlength="50" /></div>\n'+
	'				<div class="label">'+ i2b2.hive.cfg.password_label +
	//Password: 
	'</div>\n'+
	//JIRA|SHRINE-519: Charles McGow
	'				<div class="input"><input type="password" name="pword" id="loginpass" value="" size="20" maxlength="50" /></div>\n'+
	//JIRA|SHRINE-527:Charles McGow
	'				<div class="label" id="shrine_host_label">SHRINE Host:</div>\n'+
	'				<div class="input" id="shrine_host_opt_input">'+
	'<select name="server" id="logindomain"><option value="">Loading...</option></select></div>\n'+
	//JIRA|SHRINE-527:Charles McGow

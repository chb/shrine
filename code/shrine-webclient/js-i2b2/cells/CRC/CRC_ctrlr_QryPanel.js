...
// JIRA|SHRINE-511:Charles McGow
var crc_ctrl_QryPanel_ballon_pnl_term1 = "drag a<br />term<br />to here";
// JIRA|SHRINE-511:Charles McGow
	...
	this._redrawPanelStyle = function(pd) {
		if (undefined===pd) {
			...
			if (this.panelCurrentIndex == i2b2.CRC.model.queryCurrent.panels.length) {
				...
				// JIRA|SHRINE-511:Charles McGow
				this.refBalloon.innerHTML = crc_ctrl_QryPanel_ballon_pnl_term1;
				// JIRA|SHRINE-511:Charles McGow
